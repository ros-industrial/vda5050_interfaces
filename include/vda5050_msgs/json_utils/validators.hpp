...
static void date_time_format_checker(const std::string& format, const std::string& value)
{
    if (format == "date-time")
    {
...
{
    nlohmann::json_schema::json_validator validator(nullptr, date_time_format_checker);
